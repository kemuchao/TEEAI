...
class TEEForgetPasword: ABCBaseVC {
    ...
    override func viewWillAppear(_ animated: Bool) {
        self.navigationController?.navigationBar.isHidden = false
         NotificationCenter.default.addObserver(self, selector: #selector(TEEForgetPasword.loginSuccess), name: NSNotification.Name(rawValue: NotifyReloadData), object: nil)
    }
