...
- (void)viewDidLoad {
    ...
    self.title = Localized(@"CustomerSoftWareUpdate");
    [self loadMainView];
...
- (void)loadMainView{
    BOOL highlight = NO;
    UpdateTopView *viewTop = [[UpdateTopView alloc] initWithFrame:CGRectMake(0, HeightNanvi, SCREEN_WIDTH, HeightLabel*2 + HeightLabel*5) titles:@[@"当前版本:1.2.65",@"有新版本:1.5.92"] isHighlight:highlight];
