...
func presentSetNewworkVC() {
    ABCProgressHUD.dismiss()
//    let mifiSetVC = UIStoryboard(name: kStoryBoard_Login, bundle: nil).instantiateViewController(withIdentifier: "mifiSetVC")
//
//    let window = UIApplication.shared.delegate?.window
//    window??.rootViewController?.present(mifiSetVC, animated: true, completion: nil)
//    biz.setVC.dismiss(animated: true, completion: nil)
//    biz.setVC = mifiSetVC
...
// 友盟分享
//func uMSocialManagerShare(image:UIImage, platformType:UMSocialPlatformType, vc: UIViewController) {
//
//    //创建网页内容对象
//    let shareObject = UMShareImageObject.shareObject(withTitle: "魔漫运动", descr: "我的运动详情", thumImage: image)
//    shareObject?.shareImage = image
//   
//    //创建分享消息对象
//    let messageObject = UMSocialMessageObject(mediaObject: shareObject)
//    
//    UMSocialManager.default().share(to: platformType, messageObject: messageObject, currentViewController: vc) { (data, error) in
//        if (error != nil) {
//            ABCProgressHUD.showSuccessWithStatus(string: "分享失败")
